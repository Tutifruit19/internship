...
tab_2 = open_SR_tab("/home/aurelienh/Desktop/Int/task_3_4/result/output_SR_oxidised_enso8_2019.csv")
...
def plot_1(index_value):
    ...
    plt.savefig("/home/aurelienh/Desktop/Int/task_3_4/result/enso_comp_8_oxidised/all_sources_contribution/all_sources_contribution_for_"+str(tab_1[1][index_value])+".jpg",dpi=1000)
    plt.close()
...
def plot_2(index_value):
    ...
    plt.legend()
    plt.xticks(rotation=45,fontsize=8)
    plt.savefig("/home/aurelienh/Desktop/Int/task_3_4/result/enso_comp_8_oxidised/ratio/ratio_sources_"+str(tab_1[1][index_value])+".jpg",dpi=1000)
    plt.close()
